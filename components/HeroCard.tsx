    ...
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px]">
        ...
        <CardFooter>
          <div>
            <a
              ...
              href="github.com/hitarthsheth07/anonymous-message"
              target="_blank"
            ...
            <a
              rel="noreferrer noopener"
              href="linkedin.com/in/hitarth-sheth07"
              target="_blank"
              className={buttonVariants({
                variant: "ghost",
                size: "sm",
      ...
      <Card className="absolute top-[150px] left-[50px] w-72  drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader>
          ...
          <CardDescription>
            Send message to anyone anytime for free!
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex">
          <div className="space-y-4">
            {["Unlimited messages", "Send message to anyone", "Free for lifetime"].map(
              (benefit: string) => (
                <span
                  key={benefit}
                  className="flex"
      ...
      <Card className="absolute w-[350px] -right-[10px] bottom-[35px]  drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        <CardHeader className="space-y-1 flex md:flex-row justify-start items-start gap-4">
          ...
          <div>
            <CardTitle>Dummy Text</CardTitle>
